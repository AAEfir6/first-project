...
<br>e. Member 5 (Lo Tin Yau Ronald)

  It was a valuable journey to attend AAE project to learn a new computer lanuage and the concept of path planning. Since I was completely new to the coding, it is quit challenging for me to finish this project. It is doubt for me that is it really possible to learn to code is few weeks but I got the answer at the end which is yes. I am responsible on the additional tasks which is harder tasks. With the aids of the internet and lecturer, I found that it is not that difficult as long as I am willing to put effort on it. I am not sure that I did a great job on the tasks I have done but I am sure that I have learnt a lot. Beside the technical stuffs, I learnt how to communicate and collaborate with different people. In the learning field, I understand that there are no way to be shy or shame for not being smart at different courses. We should be more active and passionate to learn. 
  Beside the mental outcomes, I learnt that how to be a self-learner in a efficient way. Taking this project as example, I don't know any concept or algorithm about path planning not even what a* algorithm, d* algorithm, etc. After the lecture time, it is a treasure to learn related extra information from different academic acticle or essay from library or interent. Therefore, I learnt to how to learn, the learning method for my academic life.
  Thanks for the lecture from Dr. Hsu, the lectures are inspiring especially the last lecture of the outlook and discussion. Thanks for my groupmates who are helpful and kind. We are working as team that we are willing to help each others to solve problems and responsible for taking up different tasks to finish.

## References
- Ahmad, Z., Ullah, F., Tran, C., & Lee, S. (2017). Efficient energy flight path planning algorithm using 3-d visibility roadmap for small unmanned aerial vehicle. International Journal of Aerospace Engineering, 2017.
...
- Sabo, Chelsea & Cohen, Kelly. (2012). Fuzzy Logic UAV (Unmanned Aerial Vehicle) Motion Planning. Advances in Fuzzy Systems. 2012. 14. 10.1155/2012/989051.
...
- Khokhar, A. (2021, February 12). Probabilistic roadmap (PRM) for path planning in Robotics. Medium. Retrieved November 12, 2021, from https://medium.com/acm-juit/probabilistic-roadmap-prm-for-path-planning-in-robotics-d4f4b69475ea. 
- Robotic Motion Planning: A* and D* search. (n.d.). Retrieved November 12, 2021, from https://www.cs.cmu.edu/~motionplanning/lecture/AppH-astar-dstar_howie.pdf. 
- Firas A. Raheema, Umniah I. Hameed, T. (n.d.). Path Planning Algorithm using D* Heuristic Method Based on PSO in Dynamic Environment. View of path planning algorithm using D* heuristic method based on PSO in dynamic environment. Retrieved November 12, 2021, from https://asrjetsjournal.org/index.php/American_Scientific_Journal/article/view/4515/1604. 
